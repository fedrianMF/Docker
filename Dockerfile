...
RUN apt-get update && apt-get install -y unzip zlib1g-dev \
    libpng-dev libicu-dev libxml2-dev libxslt-dev libzip-dev libjpeg-dev libfreetype6-dev
# installing PHP requirements (ctype, curl, dom, hash, iconv, mbstring, openssl, simplexml. already installed)
